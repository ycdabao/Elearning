...
function clippic(){
    ...
    html2canvas(document.getElementById("backgroundimg"), {
      onrendered: function(canvas) {
		...
		var savePng = imgData.replace("image/png", strDownloadMime);
		
		
		var save_link = document.createElementNS('http://www.w3.org/1999/xhtml', 'a');
		var date = new Date();
		var dateStr = date.getHours()+"-"+date.getMinutes()+"-"+date.getSeconds();
		save_link.href = savePng;
		save_link.download = "yidong-"+dateStr+".png";
